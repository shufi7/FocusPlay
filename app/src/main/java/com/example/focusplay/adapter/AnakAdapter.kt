...
class AnakAdapter(
    ...
    // Menghubungkan elemen item_anak.xml, mengisi data anak, serta menangani klik dan tekan lama.
    ...
    // Membuat satu kartu RecyclerView dari layout item_anak.xml.
    ...
    // ==================== BAGIAN BINDING DAN JUMLAH DATA ====================
    // Mengisi kartu berdasarkan posisi data dan memberi jumlah item kepada RecyclerView.
